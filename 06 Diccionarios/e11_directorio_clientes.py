...
# descuento que se le aplica. Las líneas se separan con el carácter
...
# Escribir un programa que genere un diccionario con la información
# del directorio, donde cada elemento corresponda a un cliente y
# tenga por clave su nif y por valor otro diccionario con el resto
# de la información del cliente. Los diccionarios con la información
# de cada cliente tendrán como claves los nombres de los campos y
# como valores la información de cada cliente correspondientes a los
...
Entradas:
datos_clientes (str): Datos de entrada
lista_clientes (str): Lista separada por ;
directorio (dict): Diccionario
lista_campos (list): Lista con los campos extraidos de datos de entrada
clientes (dict): Diccionario de clientes
lista_info (list): Lista de información

Salidas:
(dict): Directorio con información organizada """
